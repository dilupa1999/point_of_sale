...
public class AddSupplierPanel extends JPanel {
    ...
    public AddSupplierPanel(MainFrame mainFrame) {
    ...
    private void initComponents(MainFrame mainFrame) {
        ...
        // Breadcrumbs
        JLabel lblBreadcrumb = new JLabel("Main Panel > Suppliers > Add New Supplier");
        ...
        // Row 1: Supplier Name and Mobile Number
        gbc.gridy = 0;
        gbc.gridx = 0;
        pnlForm.add(createLabel("Supplier Name"), gbc);
        gbc.gridx = 1;
        pnlForm.add(createLabel("Mobile Number"), gbc);
        
        gbc.gridy = 1;
        gbc.gridx = 0;
        pnlForm.add(createTextField("Enter supplier name"), gbc);
        gbc.gridx = 1;
        ...
        gbc.gridx = 0;
        gbc.gridwidth = 2;
        pnlForm.add(createLabel("Email Address"), gbc);
        gbc.gridy = 3;
        pnlForm.add(createTextField("Enter email address"), gbc);

        // Row 3: Address and City Name
        gbc.gridy = 4;
        gbc.gridx = 0;
        gbc.gridwidth = 1;
        pnlForm.add(createLabel("Address"), gbc);
        gbc.gridx = 1;
        pnlForm.add(createLabel("City Name"), gbc);
        
        gbc.gridy = 5;
        gbc.gridx = 0;
        pnlForm.add(createTextField("Enter address"), gbc);
        gbc.gridx = 1;
        ...
        pnlButtons.add(createActionButton("Reset", new Color(139, 195, 74)));
