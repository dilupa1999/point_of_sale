...
public class PermissionListPanel extends JPanel {
    ...
    public PermissionListPanel(MainFrame mainFrame) {
    ...
    private void initComponents(MainFrame mainFrame) {
        ...
        JLabel lblBreadcrumb = new JLabel("Main Panel > Users > Permission List");
        ...
        JTextField txtSearch = new JTextField("Enter Permission name", 25);
        ...
        // --- Table ---
        String[] columns = {"#", "PERMISSION NAME", "MANAGE"};
        ...
        table.getColumnModel().getColumn(2).setCellRenderer(new ManageRenderer());
    ...
    private void addSampleData() {
        tableModel.addRow(new Object[]{"1", "aaaaa1111", ""});
        tableModel.addRow(new Object[]{"2", "dashboards", ""});
        tableModel.addRow(new Object[]{"3", "Access_Dashbord", ""});
        tableModel.addRow(new Object[]{"4", "Access_Billing", ""});
        tableModel.addRow(new Object[]{"5", "Access_Items", ""});
        tableModel.addRow(new Object[]{"6", "Access_Stock", ""});
        tableModel.addRow(new Object[]{"7", "Access_Sales", ""});
    }
    ...
    class ManageRenderer extends DefaultTableCellRenderer {
        ...
        private JButton styleManageButton(String text, Color bg, Color fg) {
            ...
            btn.setOpaque(true);
            btn.setPreferredSize(new Dimension(55, 30));
            return btn;
        }
    }
}
