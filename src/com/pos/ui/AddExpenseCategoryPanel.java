...
public class AddExpenseCategoryPanel extends JPanel {
    ...
    private void initComponents(MainFrame mainFrame) {
        ...
        // Breadcrumbs
        JLabel lblBreadcrumb = new JLabel("Main Panel > Expenses > Add Expense Category");
        ...
        // Row 1: Expense Category (Full Width)
        gbc.gridy = 0;
        gbc.gridx = 0;
        pnlForm.add(createLabel("Expense Category"), gbc);
        
        gbc.gridy = 1;
        pnlForm.add(createTextField("Enter expense category"), gbc);
        ...
        pnlButtons.add(createActionButton("Add", resetGreen)); 
        pnlButtons.add(createActionButton("Reset", resetGreen));
        ...
        // Centering the form vertically to match screenshot look
