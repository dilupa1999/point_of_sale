...
public class YearlySummaryReportPanel extends JPanel {
    ...
    public YearlySummaryReportPanel(MainFrame mainFrame) {
    ...
    private void initComponents(MainFrame mainFrame) {
        ...
        JLabel lblBreadcrumb = new JLabel("Main Panel > Reports > Yearly Summary Report");
        ...
        pnlFilters.add(createFilterPanel("Year", new JComboBox<>(new String[]{"2026", "2025", "2024"}), 180));
        ...
        table.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                ...
                // Special styling for Net Profit column
                if (column == 12) {
