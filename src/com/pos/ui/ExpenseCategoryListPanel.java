...
public class ExpenseCategoryListPanel extends JPanel {
    ...
    public ExpenseCategoryListPanel(MainFrame mainFrame) {
    ...
    private void initComponents(MainFrame mainFrame) {
        ...
        JLabel lblBreadcrumb = new JLabel("Main Panel > Expenses > Expenses Category List");
        ...
        JTextField txtSearch = new JTextField("Enter Expense Category");
        ...
        String[] columns = {"#", "EXPENSE CATEGORY", "MANAGE"};
    ...
    private void addSampleData() {
        tableModel.addRow(new Object[]{"1", "Marketing and Advertising", ""});
        tableModel.addRow(new Object[]{"2", "Equipment and Technology", ""});
        tableModel.addRow(new Object[]{"3", "Inventory Loss", ""});
    }
