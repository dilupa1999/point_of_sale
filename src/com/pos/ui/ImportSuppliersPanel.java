...
public class ImportSuppliersPanel extends JPanel {
    ...
    public ImportSuppliersPanel(MainFrame mainFrame) {
    ...
    private void initComponents(MainFrame mainFrame) {
        ...
        // Breadcrumbs
        JLabel lblBreadcrumb = new JLabel("Main Panel > Suppliers > Import Suppliers");
        ...
        String[] columns = {"#", "SUPPLIER CODE", "SUPPLIER NAME", "MOBILE NUMBER", "ADDRESS LINE 1", "CITY NAME", "EMAIL", "DUE AMOUNT", "USER ID", "CITY ID", "STATUS ID"};
