...
public class RolesListPanel extends JPanel {
    ...
    public RolesListPanel(MainFrame mainFrame) {
    ...
    private void initComponents(MainFrame mainFrame) {
        ...
        JLabel lblBreadcrumb = new JLabel("Main Panel > Users > Role List");
        ...
        JTextField txtSearch = new JTextField("Enter role name", 25);
        ...
        // --- Table ---
        String[] columns = {"#", "ROLE", "PERMISSION COUNT", "MANAGE"};
        ...
        table.getColumnModel().getColumn(3).setCellRenderer(new ManageRenderer());
    ...
    private void addSampleData() {
        tableModel.addRow(new Object[]{"1", "admin", "77", ""});
        tableModel.addRow(new Object[]{"2", "manager", "26", ""});
        tableModel.addRow(new Object[]{"3", "Super Admin", "8", ""});
        tableModel.addRow(new Object[]{"4", "Cashier", "2", ""});
    }
