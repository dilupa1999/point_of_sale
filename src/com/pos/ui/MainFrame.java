...
public class MainFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        btnUp.setBackground(sidebarBg);
        JButton btnDown = new JButton(">");
        btnDown.setBackground(sidebarBg);
        pnlNav.add(btnUp);
        pnlNav.add(btnDown);
        ...
        CustomerListPanel clp = new CustomerListPanel(this);
        mainContent.add(clp, "CustomerList");
        mainContent.putClientProperty("CustomerListPanel", clp); // store for easy retrieval
        ...
        JLabel lblFooterText = new JLabel(
                "2026 \u00a9 All Rights Reserved | Designed and Developed by Silicon Radon Networks (Pvt) Ltd");
    ...
    public CustomerListPanel getCustomerListPanel() {
        return (CustomerListPanel) mainContent.getClientProperty("CustomerListPanel");
    }
