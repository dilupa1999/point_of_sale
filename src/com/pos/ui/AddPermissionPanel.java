...
public class AddPermissionPanel extends JPanel {
    ...
    public AddPermissionPanel(MainFrame mainFrame) {
    ...
    private void initComponents(MainFrame mainFrame) {
        ...
        // Breadcrumbs
        JLabel lblBreadcrumb = new JLabel("Main Panel > Users > Add New Permission");
        ...
        // Container for Permission Input
        JPanel pnlPermissionBox = new JPanel(new BorderLayout(0, 10));
        pnlPermissionBox.setBackground(Color.WHITE);
        pnlPermissionBox.setBorder(BorderFactory.createCompoundBorder(
            new LineBorder(new Color(230, 230, 235), 1, true),
            new EmptyBorder(20, 20, 20, 20)
        ));

        JLabel lblPermission = new JLabel("Permission");
        lblPermission.setFont(fontBold14);
        pnlPermissionBox.add(lblPermission, BorderLayout.NORTH);

        JTextField txtPermission = new JTextField("Enter permission");
        txtPermission.setPreferredSize(new Dimension(0, 40));
        txtPermission.setBackground(fieldBg);
        txtPermission.setBorder(new LineBorder(new Color(220, 220, 225)));
        txtPermission.setForeground(Color.GRAY);
        pnlPermissionBox.add(txtPermission, BorderLayout.CENTER);
        ...
        pnlPermissionBox.add(pnlButtons, BorderLayout.SOUTH);

        gbc.gridy = 0;
        gbc.anchor = GridBagConstraints.NORTH;
        pnlFormContainer.add(pnlPermissionBox, gbc);
