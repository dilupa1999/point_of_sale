...
public class ExpensesListPanel extends JPanel {
    ...
    public ExpensesListPanel(MainFrame mainFrame) {
    ...
    private void initComponents(MainFrame mainFrame) {
        ...
        JLabel lblBreadcrumb = new JLabel("Main Panel > Expenses > Expenses List");
        ...
        JTextField txtSearch = new JTextField("Enter expense title");
        ...
        String[] columns = {"ID", "EXPENSE TITLE", "EXPENSE CATEGORY", "AMOUNT", "CREATED AT", "MANAGE"};
    ...
    private void addSampleData() {
        tableModel.addRow(new Object[]{"1", "Print and Promotions", "Marketing and Advertising", "20000.00", "2026-02-23", ""});
        tableModel.addRow(new Object[]{"2", "Loyalty Programs", "Marketing and Advertising", "5000.00", "2026-02-24", ""});
        tableModel.addRow(new Object[]{"3", "Digital Marketing", "Marketing and Advertising", "20000.00", "2026-02-26", ""});
    }
